...
export default function PricingPage() {
  return <>
    <section className="mx-auto max-w-6xl px-5 py-16 lg:py-20">
      ...
      <h1 className="mt-3 max-w-2xl font-display text-[2.4rem] font-bold leading-[1.05] tracking-[-0.04em] text-stone-950 sm:text-5xl">
        One price per workspace. {TRIAL_DAYS} days to make up your mind.
      </h1>
      <p className="mt-5 max-w-xl text-lg leading-8 text-stone-600">
        Every plan starts as a free trial with no credit card. Add a payment method whenever you are ready.
      </p>
          ...
          return (
            ...
            >
              <div className="flex items-center justify-between">
                <h2 className={`font-display text-xl font-bold tracking-[-0.02em] ${featured ? "text-white" : "text-stone-900"}`}>{plan.name}</h2>
