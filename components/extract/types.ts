...
export type StagedFile = { localId: string; file: File | null; filename: string; sizeBytes: number; mimeType: string; previewUrl: string | null; documentId: string | null; status: StagedFileStatus; error: string | null; relativePath?: string }
