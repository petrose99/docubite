...
export function FolderReport() {
  return (
    <section id="folders" className="border-t border-cream-200 bg-cream-100">
      <div className="mx-auto grid max-w-6xl items-center gap-14 px-5 py-20 lg:grid-cols-[0.95fr_1.05fr]">
        <Reveal className="lg:order-2">
          ...
          <h2 className="mt-3 font-display text-4xl font-bold leading-[1.05] tracking-[-0.035em] text-stone-950 sm:text-5xl">
            Nobody reads a pile of forty documents. <span className="text-emerald-600">So the folder does it.</span>
          </h2>
        ...
        <Reveal delay={0.15} className="lg:order-1">
          <div className="-rotate-1 overflow-hidden rounded-[1.4rem] rounded-tr-md border border-cream-200 bg-white shadow-[0_40px_80px_-50px_rgba(41,37,36,.5)]">
